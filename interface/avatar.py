...
class YunaAvatar:
    def __init__(self):
        ...
        ctk.CTkButton(self.app, text="💬  Hablar", width=self.ancho,
                      ...
                      command=lambda: abrir_terminal("cd ~/yuna && python -m interface.cli")).pack(pady=3)
        
        ctk.CTkButton(self.app, text="⚡  Ejecutar", width=self.ancho,
                      fg_color="#185FA5", hover_color="#0f4578",
                      command=lambda: abrir_terminal("cd ~/yuna && python -m interface.agent_cli")).pack(pady=3)
        ...
        ctk.CTkButton(self.app, text="🧠  Aprender", width=self.ancho,
                      ...
                      command=lambda: abrir_terminal("cd ~/yuna && python -m yuna_aprender")).pack(pady=3)
        ...
        self.label_img.bind("<B1-Motion>", self.mover)
        ctk.CTkLabel(self.app, text="").bind("<B1-Motion>", self.mover)
    ...
    def cerrar_yuna(self):
        # Cerrar tabs de Terminal con "yuna"
